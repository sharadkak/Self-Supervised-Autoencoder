...
def save_image(image, dir='/netscratch/kakran/AE_with_tiles/skeleton/res/saved_test_input', name=1):
...
def crop_tiles(tiles):
    ...
    new_tiles = np.array(np.random.randint(0, 255, size = ( 9, 96, 96, 3),dtype = 'uint8' ))
    for i in range(9):
