...
class SegNet(nn.Module):
    ...
    def __init__(self, num_classes ,n_init_features=3,
                 filter_config=(64, 128, 256, 512, 512), batch_size = 64, eta = [1,1]):
        ...
        # these are sigma1, sigma2 parameters for the multi loss
        self.log_vars = nn.Parameter(torch.Tensor(eta))
