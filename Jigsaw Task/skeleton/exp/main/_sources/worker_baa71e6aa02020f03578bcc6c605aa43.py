...
ROOT = "/netscratch/kakran/task1/skeleton/src"

permutation_set = list(itertools.permutations(list(range(9))))
...
def save_image(image, dir='/netscratch/kakran/task1/skeleton/res/saved_test_input', name=1):
...
def crop_tiles(tiles):
    ...
    new_tiles = np.array(np.random.rand(9, 96, 96, 3))
    for i in range(9):
